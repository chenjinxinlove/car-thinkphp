...
<main role="main">
        ...
        <button type="button" class="btn btn-primary" style="margin:10px 100px">新增</button>
        <div class="table-responsive">
          <table class="table table-bordered table-hover table-striped">
            ...
            <?php if(is_array($user)): foreach($user as $key=>$vo): ?><tr>
                    ...
                    <td> <?php switch($vo["pock"]): case "0": ?>管理员<?php break;?>
                            <?php case "2": ?>普通用户<?php break;?>
                            <?php case "1": ?>门卫<?php break; endswitch;?>
                    </td>
                    <td><?php echo ($vo["section"]); ?></td>
                    <td><?php echo ($vo["tel"]); ?></td>
                    <td>
                        <?php switch($vo["lock"]): case "0": ?>正常<?php break;?>
                                <?php case "1": ?>锁定<?php break; endswitch;?>
                    </td>
                    <td><a href="/car-thinkphp/index.php/Home/User/alert?id=<?php echo ($vo["id"]); ?>">改密</a> | <a href="/car-thinkphp/index.php/Home/User/cloce?id=<?php echo ($vo["id"]); ?>">改态</a> | <a href="/car-thinkphp/index.php/Home/User/del?id=<?php echo ($vo["id"]); ?>">删除</a></td>
