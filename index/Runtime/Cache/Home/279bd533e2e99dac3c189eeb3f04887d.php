...
<main role="main">
        ...
        <div class="table-responsive" style="width:500px;margin-left: 50px;margin-top:20px;">
             ...
             <form action="/car-thinkphp/index.php/Home/User/alertinfo?id=<?php echo ($id); ?>" method="post">
                  <div class="form-group">
                    <label for="exampleInputEmail1">用户名</label>
                    <p></p>
                    <label for="exampleInputEmail1"><?php echo ($content[0]["username"]); ?></label>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="section" placeholder="输入部门" value="<?php echo ($content[0]["section"]); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">电话</label>
                    <input type="text" class="form-control" name="tel" placeholder="输入部门电话" value="<?php echo ($content[0]["tel"]); ?>">
                  </div>
