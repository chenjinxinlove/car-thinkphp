...
<main role="main">
        <div class="list-group" style="width: 13%;height:495px;position: relative;left:10%;border: 1px solid #878787;padding:8px;display: inline-block;vertical-align: top;">
            ...
            <a href="<?php echo U('info');?>" style="text-decoration: none"><button type="button" class="list-group-item active" style="margin-bottom: 15px">信息反馈</button></a>
            <a href="<?php echo U('pro');?>" style="text-decoration: none"><button type="button" class="list-group-item" style="margin-bottom: 15px">常见问题</button></a>
        </div>
        <div style="width:68%;height: 495px;border: 1px solid #878787;display: inline-block;vertical-align: top;position: relative;left:11%;">
            <h2><span class="label label-primary ">请输入您需要反馈的信息</span></h2>
            <textarea class="form-control" rows="3" style="width: 100%;height: 300px;"></textarea>
            <bottom  id="info-btn" type="button" class="btn btn-primary " style="position: relative;left:90%;top:20px">提交</button>
        </div>
        <!-- <div class="container">
            <div class="row">
