...
<main role="main">
        <div class="list-group" style="width: 13%;height:495px;position: relative;left:10%;border: 1px solid #878787;padding:8px;display: inline-block;vertical-align: top;">
            <a href="/car-thinkphp/index.php/Home/Car" style="text-decoration: none">
                <button type="button" class="list-group-item active" style="margin-bottom: 15px">车辆管理</button>
            </a>
            <a href="/car-thinkphp/index.php/Home/File" style="text-decoration: none">
                <button type="button" class="list-group-item " style="margin-bottom: 15px">驾驶员管理</button>
            </a>
          ...
          <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo["numsq"]); ?></td>
                    <td><?php echo ($vo["color"]); ?></td>
                    <td><?php echo ($vo["time"]); ?></td>
                    <td><?php echo ($vo["money"]); ?></td>
                    <td><?php echo ($vo["ins_expire_time"]); ?></td>
                    <td><?php echo ($vo["ins_money"]); ?></td>
                    <td><?php echo ($vo["car_note"]); ?></td>
                    <td>
                        <?php switch($vo["state"]): case "0": ?>正常<?php break;?>
                                <?php case "1": ?>不可用<?php break; endswitch;?>
                    </td>

                    <td><a href="/car-thinkphp/index.php/Home/Car/alert?id=<?php echo ($vo["id"]); ?>">修改</a> | <a href="/car-thinkphp/index.php/Home/Car/cloce?id=<?php echo ($vo["id"]); ?>">改态</a> | <a href="/car-thinkphp/index.php/Home/Car/del?id=<?php echo ($vo["id"]); ?>">删除</a></td>
...
$('#add-btn').click(function(){ 
    ...
    layer.open({
        ...
        maxmin: true,
        area: ['60%', '80%'],
        content: '/car-thinkphp/index.php/Home/Car/add.html',
        });
